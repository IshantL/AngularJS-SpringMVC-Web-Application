...
public class TaskDetailsTO {
	...
	private Date taskduedte;
	private Date taskassigneddte;
	private Date taskcompletedte;
	...
	public Date gettaskduedte() {
		return taskduedte;
	}

	public void settaskduedte(Date taskduedte) {
		this.taskduedte = taskduedte;
	}

	public Date gettaskassigneddte() {
	...
	public Date gettaskcompletedte() {
